...
<p align="center">
  <a href="https://github.com/Ayleovelle/astrbot_plugin_sylanne/releases"><img src="https://img.shields.io/badge/version-2.5.1-blue" alt="Version 2.5.1" /></a>
...
面向 AstrBot 的长期记忆、关系状态建模与即时聊天插件，由 2718 Labs 维护。`Embodiment-2.5.1` 把一次对话中的上下文、节拍、投递和观测收在可验证的运行链路里。
...
3. 确认包内 `metadata.yaml` 的版本为 `2.5.1`。
