...
　　我在自己之前做的语音识别插件的介绍里写过一句话：“让文字不再是文字，让语言不仅是语言”。我当然知道，这样做不能让 AI 变成一个真正“有血有肉”的“虚拟人”。但如果这些冷冰冰的状态、权重、衰减和分支，最后能让一段对话没那么像机器在复读，能像在很晚的时候给代码递上一杯热茶，那我觉得这件事就已经值得继续做下去了。
