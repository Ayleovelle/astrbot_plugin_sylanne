...
| 73 | in_progress | Improve GitHub formula rendering using official mathematical expression syntax | README/docs formula blocks converted with GitHub-safe LaTeX macros; validation and package preflight passed; release asset refresh pending |
