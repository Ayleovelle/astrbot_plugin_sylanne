...
## [Embodiment-2.5.0-grey.6] - 2026-07-18

> 灰测版。跨群记忆 / QQ空间说说 / 即时聊天接管三大功能仍默认全关、行为与现网一致；本版新增一层 **v3 零-LLM 影子认知（默认关，仅灰测渠道后台激活）**——它只在后台静默学习，对你的回复、记忆、历史、人格一律零影响。
...
三大功能（跨群记忆 / QQ空间说说 / 即时聊天接管）与 grey.5 一致，默认全关、逐项开启才生效。本版是灰测迭代,主要变化是上面的 v3 影子层与其内部学习/评估机制,均不改变现网可见行为。
