...
- 预检确认 zip 内包含 clean-room 躯体创生文件 `sylanne_body/__init__.py`、`sylanne_body/event/source.py`、`sylanne_body/law/sovereignty.py`、`sylanne_body/kernel/spine.py`、`sylanne_body/soma/affect.py`、`sylanne_body/soma/crying.py`、`sylanne_body/speech/affect.py` 和 `sylanne_body/speech/crying.py`；
