...
- 💩 发酵指数：`23.4/100`，官方评价：`😐 微臭青年`（由质量分反向换算，越低越好）
- 官方 JSON overallScore：`76.6/100`
- 扫描规模：`191/310` 个文件已分析，`119` 个文件被跳过
- 问题计数：critical `141`，error `332`，warning `259`
- 原始报告：`output/fuck_u_code/raw-report.json`
- 生成时间：`2026-05-24T16:53:01+00:00`

## 最需要除味的文件

| 💩 发酵 | 质量分 | critical | error | warning | 文件 |
| --- | --- | ---: | ---: | ---: | --- |
| 61.0/100 | 38.6/100 | 8 | 2 | 1 | `main.py` |
...
| 29.0/100 | 71.3/100 | 3 | 4 | 3 | `sylanne_alpha/kernel.py` |
| 29.0/100 | 71.1/100 | 2 | 2 | 2 | `experiments/relational_sheaf_experiments.py` |
| 28.0/100 | 72.2/100 | 3 | 4 | 1 | `archive/3x_engines/fallibility_engine.py` |
| 28.0/100 | 71.7/100 | 3 | 2 | 0 | `archive/3x_engines/public_api.py` |
