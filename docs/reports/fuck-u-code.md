...
- 💩 发酵指数：`23.2/100`，官方评价：`😐 微臭青年`（由质量分反向换算，越低越好）
- 官方 JSON overallScore：`76.8/100`
- 扫描规模：`190/320` 个文件已分析，`130` 个文件被跳过
- 问题计数：critical `135`，error `332`，warning `257`
- 原始报告：`output/fuck_u_code/raw-report.json`
- 生成时间：`2026-05-21T20:19:46+00:00`

## 最需要除味的文件

| 💩 发酵 | 质量分 | critical | error | warning | 文件 |
| --- | --- | ---: | ---: | ---: | --- |
| 60.0/100 | 39.9/100 | 7 | 3 | 1 | `main.py` |
...
| 38.0/100 | 62.0/100 | 3 | 6 | 2 | `project_life_engine.py` |
