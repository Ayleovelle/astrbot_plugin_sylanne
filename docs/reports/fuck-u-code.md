...
- 💩 发酵指数：`22.1/100`，官方评价：`😐 微臭青年`（由质量分反向换算，越低越好）
- 官方 JSON overallScore：`77.9/100`
- 扫描规模：`78/133` 个文件已分析，`54` 个文件被跳过
- 问题计数：critical `80`，error `168`，warning `149`
- 原始报告：`output/fuck_u_code/raw-report.json`
- 生成时间：`2026-05-17T17:06:29+00:00`

## 最需要除味的文件

| 💩 发酵 | 质量分 | critical | error | warning | 文件 |
| --- | --- | ---: | ---: | ---: | --- |
| 48.0/100 | 51.8/100 | 7 | 2 | 1 | `integrated_self.py` |
