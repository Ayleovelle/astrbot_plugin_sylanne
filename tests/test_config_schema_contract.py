...
class ConfigSchemaContractTests(unittest.TestCase):
    ...
    def test_schema_has_core_default_values_and_types(self):
        ...
        expected = {
            ...
            "sticker_auto_download_enabled": ("bool", False),
            "sticker_auto_download_repo_url": ("string", "https://github.com/zhaoolee/ChineseBQB.git"),
            "sticker_auto_download_cache_dir": ("string", ""),
            "sticker_auto_download_timeout_seconds": ("float", 30.0),
