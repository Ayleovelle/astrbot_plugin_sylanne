...
class ConfigSchemaContractTests(unittest.TestCase):
    ...
    def test_schema_has_core_default_values_and_types(self):
        ...
        expected = {
            ...
            "background_post_assessment": ("bool", False),
            "background_post_queue_limit": ("int", 0),
            "background_post_max_workers": ("int", 5),
            ...
            "enable_group_atmosphere_state": ("bool", True),
            "group_atmosphere_injection_strength": ("float", 0.25),
            "group_atmosphere_alpha_base": ("float", 0.34),
            "group_atmosphere_alpha_min": ("float", 0.04),
            "group_atmosphere_alpha_max": ("float", 0.52),
            "group_atmosphere_half_life_seconds": ("float", 1800.0),
            "group_atmosphere_trajectory_limit": ("int", 60),
            "group_atmosphere_join_cooldown_turns": ("int", 2),
            "group_atmosphere_join_cooldown_seconds": ("float", 45.0),
            "group_atmosphere_join_cooldown_bypass_attention": ("float", 0.8),
