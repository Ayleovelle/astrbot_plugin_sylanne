...
PLUGIN_DICT_ATTRIBUTES = (
    ...
    "_sylanne_memory_record_embedding_last_at",
    "_sylanne_memory_pending_observations",
    "_sylanne_memory_idle_tasks",
    "_sylanne_memory_idle_generation",
    ...
    "_background_post_checkpoint_session_tasks",
