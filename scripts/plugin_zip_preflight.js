...
function assertZipLooksUploadable(zipPath, expectedPlugin, options = {}) {
  ...
  const requiredEntries = [
    ...
    `${expectedPlugin}/pages/dashboard/index.html`,
    `${expectedPlugin}/sylanne_alpha/__init__.py`,
    `${expectedPlugin}/sylanne_alpha/host.py`,
    `${expectedPlugin}/sylanne_alpha/kernel.py`,
    `${expectedPlugin}/sylanne_alpha/runtime.py`,
    `${expectedPlugin}/sylanne_alpha/computation_spine.py`,
    `${expectedPlugin}/sylanne_alpha/memory_system.py`,
    `${expectedPlugin}/sylanne_alpha/webui.py`,
    `${expectedPlugin}/sylanne_alpha/webui_server.py`,
    `${expectedPlugin}/sylanne_alpha/compat/__init__.py`,
  ];
