...
function assertZipLooksUploadable(zipPath, expectedPlugin, options = {}) {
  ...
  const requiredEntries = [
    ...
    `${expectedPlugin}/realtime_chat_engine.py`,
    ...
    `${expectedPlugin}/project_life_engine.py`,
    ...
    `${expectedPlugin}/sylanne/__init__.py`,
    `${expectedPlugin}/sylanne/body_runtime/__init__.py`,
    `${expectedPlugin}/sylanne/body_runtime/adapter.py`,
    `${expectedPlugin}/sylanne/body_runtime/body.py`,
    `${expectedPlugin}/sylanne/body_runtime/contracts.py`,
    `${expectedPlugin}/sylanne/body_runtime/organs.py`,
    ...
    `${expectedPlugin}/sylanne_body/host_context.py`,
    ...
    `${expectedPlugin}/sylanne_body/law/__init__.py`,
    `${expectedPlugin}/sylanne_body/law/sovereignty.py`,
    `${expectedPlugin}/sylanne_body/law/immunity.py`,
    `${expectedPlugin}/sylanne_body/memory/__init__.py`,
    ...
    `${expectedPlugin}/sylanne_body/soma/affect.py`,
    `${expectedPlugin}/sylanne_body/soma/crying.py`,
    `${expectedPlugin}/sylanne_body/speech/__init__.py`,
    `${expectedPlugin}/sylanne_body/speech/affect.py`,
    `${expectedPlugin}/sylanne_body/speech/crying.py`,
    `${expectedPlugin}/sylanne_body/speech/gate.py`,
    `${expectedPlugin}/sylanne_body/adapter.py`,
    ...
    `${expectedPlugin}/docs/assets/theory_feature_matrix_overhead.png`,
    `${expectedPlugin}/docs/assets/theory_feature_matrix_overhead.svg`,
